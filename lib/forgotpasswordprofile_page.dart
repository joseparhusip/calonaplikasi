...
class ForgotPasswordProfilePage extends StatefulWidget {
  const ForgotPasswordProfilePage({super.key});
  @override
  State<ForgotPasswordProfilePage> createState() =>
      _ForgotPasswordProfilePageState();
}

class _ForgotPasswordProfilePageState extends State<ForgotPasswordProfilePage> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success']) {
          ...
          // Navigate to EditProfilePage after a short delay
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Back button - Navigate to EditProfilePage
                  GestureDetector(
                    onTap: () {
                      Navigator.pushReplacement(
                        context,
